<div id="table">
  ...
  <div class="row center">
    <div class="col-sm-12">
        <table width="100%" class="report-table">
          <tr >
            <td class="report-th" style="text-align: left !important;" colspan="3">คลังพักฐานข้อมูล</td>
          </tr>
          <tr>
            <td class="report-th">ฐานข้อมูล</td>
            <td class="report-th" width="15%">จำนวน (รายการ)</td>
            <td class="report-th" width="15%">ขนาดข้อมูล</td>
          </tr>
          <?php
          foreach ($list_dtawh as $row) {
          ?>
          <tr >
              <td class="report-td-a left"><?php echo $row['table_name'];?></td>
              <td class="report-td-a right"><?php echo number_format($row['count_row']);?></td>
              <td class="report-td-a right"><?php echo number_format($row['size'],2);?> MB</td>
          </tr>
          <?php } ?>
        </table>
    </div>
