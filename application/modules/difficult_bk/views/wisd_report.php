...
<div id="menu-navbar" class="navbar-inner navbar-fixed-top">
  ...
  <span class="report-name" style="max-width: 70%"><?php echo $title;?></span>
    <ul class="nav navbar-top-links navbar-right">
      <li id="summary">
        <div onclick="getData('<?php echo site_url(); ?>/difficult/wisd_summary');">
        <div class="font-icon-tab"><i class="fa fa-bar-chart" aria-hidden="true"></i></div>
        </div>
      </li>
      <li id="table">
        <div onclick="getData('<?php echo site_url(); ?>/difficult/wisd_table_area');">
...
$(document).ready(function() {
    ...
    getData('<?php echo site_url(); ?>/difficult/wisd_summary');
    getDataArea('<?php echo site_url(); ?>/difficult/wisd_map');
});
</script>
