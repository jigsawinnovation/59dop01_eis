<div id="table">
  <div class="row center">
    <div class="col-xs-6 col-sm-9">
       ...
       <input type="search" class="input-search" placeholder="ค้นหา" id="txtSearch"/>
       </div>
    </div>
    <div class="col-sm-3">
        <button class="report-btn-search">ค้นหาขั้นสูง</button>
    </div>
  </div>
  <div class="row center">
    <div class="col-sm-12">
          ...
          ?>
            <tr >
              <td class="<?php echo $class_td;?> center">
                <i class="fa fa-angle-left" aria-hidden="true"  onclick="getData('<?php echo site_url(); ?>/difficult/impv_table_area');"></i>
              </td>
