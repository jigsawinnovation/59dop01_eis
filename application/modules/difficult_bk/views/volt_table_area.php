    ...
    <div class="col-sm-12" id="display_info">
        <table width="100%" class="report-table">
          <tr >
            ...
            <td class="report-th" colspan="4">ปริมาณ (ราย)</td>
            <td class="report-th" rowspan="3" width="5%"></td>
          </tr>
          <tr >
            <td class="report-th" colspan="3">พื้นที่</td>
        ...
        if($list_area){
          ...
          ?>
            <tr >
              ...
              <td class="<?php echo $class_td;?> center" onclick="getData('<?php echo site_url(); ?>/difficult/volt_table/<?php echo $row['area_id'];?>');">
