      ...
      <div class="col-sm-12">
          <table width="100%" class="report-table">
            <tr >
              ...
              <td class="report-th" colspan="4">ผลการดำเนินงาน (คน)</td>
            </tr>
            <tr>
          ...
          <?php
          $intRow = 0;
          $total_count_of_home = 0;
          $total_sum_home_pay_amount = 0;
          $total_count_of_place = 0;
          $total_sum_place_pay_amount = 0;
          $arr_class_td = array('report-td-a','report-td-b');
          if($summary){
            foreach ($summary as $row) {
            $intRow++;
            $class_td = $arr_class_td[$intRow%2];
            $total_count_of_home += $row['count_of_home'];
            $total_sum_home_pay_amount += $row['sum_home_pay_amount'];
            $total_count_of_place += $row['count_of_place'];
            $total_sum_place_pay_amount += $row['sum_place_pay_amount'];
            ?>
              <tr >
          ...
          <tr >
            ...
            <?php
            if($total_count_of_home > 0){
                echo number_format($total_count_of_home);
            }else{
                echo '';
            }
            ?>
            ...
            <td class="report-td-sum right">
            <?php
            if($total_sum_home_pay_amount > 0){
                echo number_format($total_sum_home_pay_amount,2);
            }else{
                echo '';
            }
            ?>
            ...
            <td class="report-td-sum right">
            <?php
            if($total_count_of_place > 0){
                echo number_format($total_count_of_place);
            }else{
                echo '';
            }
            ?>
            ...
            <td class="report-td-sum right">
            <?php
            if($total_sum_place_pay_amount > 0){
                echo number_format($total_sum_place_pay_amount,2);
            }else{
                echo '';
            }
            ?>
