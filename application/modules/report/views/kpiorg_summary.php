    ...
    <div class="row center">
      <div class="col-sm-12">
        ...
        ?>
        {
          ...
          "visits": <?php echo round($row['count_ma']+$row['count_fa']);?>,
          "visits2": <?php echo round($row['count_mb']+$row['count_fb']);?>,
          "visits3": <?php echo round($row['count_mc']+$row['count_fc']);?>,
          "visits4": <?php echo round($row['count_m_no']+$row['count_f_no']);?>
        },
        <?php
        }
        ?>
      ...
      <div class="col-sm-12">
          <table width="100%" class="report-table">
            <tr>
              ...
              <td colspan="10" class="report-th" >ปริมาณผู้รับบริการ (คน)</td>
          ...
          if($summary){
            ...
            $total_ma += $row['count_ma'];
            $total_mb += $row['count_mb'];
            $total_mc += $row['count_mc'];
            $total_m_no += $row['count_m_no'];
            $sum_m[$index] = $row['count_ma']+$row['count_mb']+$row['count_mc']+$row['count_m_no'];
            $total_sum_m += $sum_m[$index];

            $total_fa += $row['count_fa'];
            $total_fb += $row['count_fb'];
            $total_fc += $row['count_fc'];
            $total_f_no += $row['count_f_no'];
            $sum_f[$index] = $row['count_fa']+$row['count_fb']+$row['count_fc']+$row['count_f_no'];
            $total_sum_f += $sum_f[$index];

            $sum_fm[$index] = $sum_m[$index]+$sum_f[$index];
            $total_sum_all += $sum_m[$index]+$sum_f[$index];
            ?>
              <tr >
                ...
                <?php
                if($row['count_ma'] > 0){
                    echo number_format($row['count_ma']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_mb'] > 0){
                    echo number_format($row['count_mb']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_mc'] > 0){
                    echo number_format($row['count_mc']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_m_no'] > 0){
                    echo number_format($row['count_m_no']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_fa'] > 0){
                    echo number_format($row['count_fa']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_fb'] > 0){
                    echo number_format($row['count_fb']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_fc'] > 0){
                    echo number_format($row['count_fc']);
                }else{
                    echo '';
                }
                ?>
                ...
                <?php
                if($row['count_f_no'] > 0){
                    echo number_format($row['count_f_no']);
                }else{
                    echo '';
                }
                ?>
