    ...
    <div class="col-sm-12" id="display_info">
        <table width="100%" class="report-table">
          <tr >
            ...
            <td class="report-th" colspan="3">ปริมาณผู้รับบริการ (คน)</td>
            <td class="report-th" rowspan="2" width="5%"></td>
          </tr>
          <tr>
        ...
        if($list_org){
          ...
          ?>
            <tr >
              ...
              <td class="<?php echo $class_td;?> center" onclick="getData('<?php echo site_url().report_url(); ?>kpiorg_report/kpiorg_table/<?php echo $row['org_id'];?>');">
...
$( "#quick_search" ).keyup(function() {
    ...
    var url_search = '<?php echo site_url(); ?>/report/kpiorg_report/service_table_search';
    $.ajax({
      method: "GET",
      url: url_search,
