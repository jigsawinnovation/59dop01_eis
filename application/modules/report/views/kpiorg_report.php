...
<div id="menu-navbar" class="navbar-inner navbar-fixed-top">
    ...
    <ul class="nav navbar-top-links navbar-right">
      <li id="summary">
        <div onclick="getData('<?php echo site_url().report_url(); ?>kpiorg_report/kpiorg_summary');">
        <div class="font-icon-tab"><i class="fa fa-bar-chart" aria-hidden="true"></i></div>
        </div>
      </li>
      <li id="table">
        <div onclick="getData('<?php echo site_url().report_url(); ?>kpiorg_report/kpiorg_table_area');">
...
$(document).ready(function() {
    ...
    getData('<?php echo site_url().report_url(); ?>kpiorg_report/kpiorg_summary');
    getDataArea('<?php echo site_url().report_url(); ?>kpiorg_report/kpiorg_map');
