<div id="summary" class="ui-body-d ui-content">
    <div class="row center">
      ...
      <div class="col-sm-12">
          ...
          $total_count_of_export = 0;
          $total_sum_time_process_export = 0;
          ...
          if($summary){
            ...
            $total_count_of_export += $row['count_of_export'];
            $total_sum_time_process_export += $row['sum_time_process_export'];
            ?>
              <tr >
          ...
          <tr >
            ...
            <td class="report-td-sum right">
            <?php
            if($total_count_of_export > 0){
                echo number_format($total_count_of_export);
            }else{
                echo '';
            }
            ?>
            ...
            <td class="report-td-sum right">
            <?php
            if($total_sum_time_process_export > 0){
                echo number_format($total_sum_time_process_export);
            }else{
                echo '';
            }
            ?>
