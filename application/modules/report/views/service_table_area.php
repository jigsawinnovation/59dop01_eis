    ...
    <div class="col-sm-12" id="display_info">
        <table width="100%" class="report-table">
          <tr >
            ...
            <td class="report-th" colspan="2">ข้อมูลการให้บริการสงเคราะห์</td>
        ...
        if($list_area){
          ...
          ?>
            <tr >
              ...
              <td class="<?php echo $class_td;?> center" onclick="getData('<?php echo site_url().report_url(); ?>service_report/service_table/<?php echo $row['area_id'];?>');">
