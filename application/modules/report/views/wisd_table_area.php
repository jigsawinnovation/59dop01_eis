    ...
    <div class="col-sm-12" id="display_info">
        <table width="100%" class="report-table">
          ...
          <tr>
            ...
            <td class="report-th" width="10%">จำนวน (ภูมิปัญญา)</td>
            <td class="report-th" width="10%">ร้อยละ</td>
          </tr>
        <?php
        $intRow = 0;
        ...
        if($list_area){
          ...
          ?>
            <tr >
              ...
              <td class="<?php echo $class_td;?> center" onclick="getData('<?php echo site_url().report_url(); ?>wisd_report/wisd_table/<?php echo $row['area_id'];?>');">
