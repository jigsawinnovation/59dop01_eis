  ...
  <div class="row center">
    <div class="col-sm-12" id="display_info">
        <table width="100%" class="report-table">
          ...
          <tr>
            <td class="report-th" width="10%">ชาย (คน)</td>
            <td class="report-th" width="10%">หญิง (คน)</td>
            <td class="report-th" width="10%">รวม (คน)</td>
            <td class="report-th" width="10%">ร้อยละ</td>
            <td class="report-th" width="10%">จำนวน (คน)</td>
            <td class="report-th" width="10%">จำนวนเงิน (บาท)</td>
            <td class="report-th" width="10%">ร้อยละ</td>
          </tr>
        <?php
        $intRow = 0;
        ...
        if($list_area){
          ...
          ?>
            <tr >
              ...
              <td class="<?php echo $class_td;?> right"><?php echo number_format($row['count_fnrl']);?></td>
              <td class="<?php echo $class_td;?> right"><?php echo number_format($row['pay_amount']);?></td>
              <td class="<?php echo $class_td;?> right"><?php echo number_format($fnrl_percent,2);?></td>
              <td class="<?php echo $class_td;?> center" onclick="getData('<?php echo site_url().report_url(); ?>fnrl_report/fnrl_table/<?php echo $row['area_id'];?>');">
          ...
          <tr >
            ...
            <td class="report-td-sum right"><?php echo number_format($total_count_fnrl);?></td>
